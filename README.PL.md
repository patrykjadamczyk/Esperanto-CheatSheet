...
Tworzenie przez liczebnik główny (wyżej) i końcówka przymiotnikowa `-a` do ostatniej części liczebnika.
- `unua` - pierwszy

### Liczebnik rzeczownikowy
Tworzenie przez liczebnik główny (wyżej) i końcówka rzeczownikowa `-o` do ostatniej części liczebnika.
- `unuo` - jedynka, jednostka
- `duo` - dwójka

### Liczebnik przysłówkowy
Tworzenie przez liczebnik główny (wyżej) i końcówka przysłówkowa `-e` do ostatniej części liczebnika.
- `unue` - po pierwsze
